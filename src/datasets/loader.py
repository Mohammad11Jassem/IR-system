...
#     """
#     Convert namedtuple, dataclass, or dictionary records
#     returned by ir_datasets into a standard dictionary.
#     """
...
#     """
#     Load a configured dataset using its short name.
#     """
...
# def load_documents(dataset_name: str) -> pd.DataFrame:
#     dataset = load_dataset(dataset_name)
#     documents = _records_to_dataframe(dataset.docs_iter())

#     if "doc_id" not in documents.columns:
#         raise ValueError("The dataset does not expose a doc_id column.")
...
#         raise ValueError("The dataset does not expose a query_id column.")

#     return queries


# def load_qrels(dataset_name: str) -> pd.DataFrame:
#     dataset = load_dataset(dataset_name)
...
#     if missing_columns:
#         raise ValueError(
#             f"Missing qrels columns: {sorted(missing_columns)}"
#         )
