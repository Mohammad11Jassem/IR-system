...
DEFAULT_INDEX_DIR = r"E:\ir_project_artifacts\indexes\faiss_word2vec_full"


def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Word2Vec FAISS index from SQLite documents."
    )
    ...
    parser.add_argument("--sg", type=int, choices=[0, 1], default=0)
