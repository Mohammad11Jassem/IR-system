...
#     # for doc_id, text in iter_sqlite_documents(db_path=db_path, limit=limit):
#     for doc_id, text in iter_sqlite_documents(
#         db_path=db_path,
#         cleaner=cleaner,
#         limit=limit,
#     ):
...
#             store.add(vectors=vectors, doc_ids=batch_doc_ids)

#             total += len(batch_texts)

#             elapsed = time.time() - start
#             print(f"Indexed {total:,} documents | elapsed: {elapsed / 60:.2f} min")
...
#         type=int,
#         default=1000,
#         help="Limit documents for first tests. Use larger values later.",
#     )
