...
def print_results(output: dict):
    ...
    if output.get("bm25_parameters"):
        params = output["bm25_parameters"]
        print(f"BM25 Params : k1={params.get('k1')} | b={params.get('b')}")
...
def main():
    ...
    parser.add_argument("--bm25-k1", type=float, default=1.2, help="BM25 k1 term-frequency saturation parameter.")
    parser.add_argument("--bm25-b", type=float, default=0.75, help="BM25 b document-length normalization parameter.")
